...
import FishinCatchCampAlex from './fishinCatchAppSrc/fishinCatchScreens/fishinCatchStackScreens/FishinCatchCampAlex';
...
const App = () => {
  ...
  OneSignal.initialize('cd84b621-e7c8-45b8-8a6f-274cd30ffb3f');
  ...
  useEffect(() => {
    ...
    const targetData = new Date('2025-10-16T08:08:00'); //дата з якої поч працювати webView
      ...
      return (
        <FishinCatchNavigation.Navigator>
          <FishinCatchNavigation.Screen
            ...
            name="FishinCatchCampAlex"
            component={FishinCatchCampAlex}
  ...
  const bounceAnim = useRef(new Animated.Value(0)).current; // для підстрибування
  ...
  useEffect(() => {
    Animated.parallel([
      Animated.spring(scaleAnim, {
        ...
        friction: 3,
        tension: 80,
        useNativeDriver: true, // було false
      }),
    ...
    // Анімація підстрибування кожні 2 секунди
  ...
  return (
    <NavigationContainer>
      <FishinCatchCntxProvider>
        {!loader ? (
          <View style={{ flex: 1, justifyContent: 'center', alignItems: 'center', backgroundColor: '#040C57', }}>
            <Animated.Image
              source={require('./assets/icons/fxemoji_fishxxxx.png')}
              style={{
                width: 200,
                height: 200,
                transform: [
